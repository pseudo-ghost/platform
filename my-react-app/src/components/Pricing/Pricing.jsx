        ...
        <table className={styles.table}>
          <thead>
            <tr>
              ...
              <th className={styles.th}>The Apprentice</th>
              <th className={styles.th}>The Specialist</th>
              <th className={styles.th}>The Master</th>
            </tr>
          </thead>
          <tbody>
            {[
              ...
              >
                <td className={styles.td}>{row[0]}</td>
                <td className={styles.td}>{row[1]}</td>
                <td className={styles.td}>{row[2]}</td>
